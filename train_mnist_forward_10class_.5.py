...
# Setup optimizer
    ...
    if os.path.isfile('10classmy_5{}.model'.format(perturbation_intensity)):
        serializers.load_npz('10classmy_5{}.model'.format(perturbation_intensity),model)
    with open('10classTestClassification_5{}.txt'.format(perturbation_intensity), 'w'): pass
...
# Learning loop
    ...
    # evaluation
        ...
        for i in xrange(0, perturbed_label_test.shape[0], batchsize):
            ...
            with open('10classTestClassification_5{}.txt'.format(perturbation_intensity),'a') as file:
        ...
        serializers.save_npz('10classmy_5{}.model'.format(perturbation_intensity),model)
